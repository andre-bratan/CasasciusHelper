...
/// <remarks>
/// Warning: It is wrong to assume there is only one connection provider in an Application
/// </remarks>
public interface IDatabaseConnectionProvider<out TDbConnection> where TDbConnection : DbConnection
{
    /// <summary>
    /// Returns a new database connection
    /// </summary>
    [MustDisposeResource]
    TDbConnection GetDatabaseConnection();
}
