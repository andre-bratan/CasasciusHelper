...
using SCrypt = CryptSharp.Utility.SCrypt;
...
namespace Casascius.Bitcoin
{
    public class Bip38Confirmation : Bip38Base
    {
        ...
        {
            get { return (flagbyte & 0x20) == 0x20; }
        }

        public override bool LotSequencePresent
        {
            get { return (flagbyte & 0x04) == 0x04; }
        }
        ...
        public Exception DecryptWithPassphrase(string passphrase)
        {
            ...
            try
            {
                ...
                if (IsCompressedPoint == false)
                {
                    ...
                    var normalized = pubpoint.Normalize();
                    var encoded = normalized.GetEncoded(false);
                    generatedaddress = new PublicKey(encoded);
                }
                else
                    generatedaddress = new PublicKey(pubpoint);
